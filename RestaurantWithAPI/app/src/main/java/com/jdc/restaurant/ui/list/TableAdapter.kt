package com.jdc.restaurant.ui.list
...
class TableAdapter:ListAdapter<Table, TableAdapter.VH>(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = VH(ItemTableBinding.inflate(
